...
public:
  ...
  : msg_(msg)
  {}
  Init_BenchCompressedPointCloud2_encoding_start_timestamp compressed_size(::benchdraco_point_cloud_interfaces::msg::BenchCompressedPointCloud2::_compressed_size_type arg)
  {
