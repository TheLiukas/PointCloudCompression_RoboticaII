...
static rosidl_typesupport_introspection_c__MessageMember benchdraco_point_cloud_interfaces__msg__BenchCompressedPointCloud2__rosidl_typesupport_introspection_c__BenchCompressedPointCloud2_message_member_array[15] = {
  {
    "header",  // name
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, benchdraco_point_cloud_interfaces, msg, BenchCompressedPointCloud2)() {
  ...
  benchdraco_point_cloud_interfaces__msg__BenchCompressedPointCloud2__rosidl_typesupport_introspection_c__BenchCompressedPointCloud2_message_member_array[9].members_ =
