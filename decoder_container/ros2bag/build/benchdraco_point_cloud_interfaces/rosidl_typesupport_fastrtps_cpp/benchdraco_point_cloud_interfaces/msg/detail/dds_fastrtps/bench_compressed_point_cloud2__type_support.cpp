...
#include "benchdraco_point_cloud_interfaces/msg/detail/bench_compressed_point_cloud2__rosidl_typesupport_fastrtps_cpp.hpp"
...
bool
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_benchdraco_point_cloud_interfaces
cdr_serialize(
  const benchdraco_point_cloud_interfaces::msg::BenchCompressedPointCloud2 & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Member: raw_size
  cdr << ros_message.raw_size;
  // Member: encoding_start_timestamp
  builtin_interfaces::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ros_message.encoding_start_timestamp,
    cdr);
  // Member: encoding_finish_timestamp
  builtin_interfaces::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ros_message.encoding_finish_timestamp,
    cdr);
  // Member: decoding_start_timestamp
  builtin_interfaces::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ros_message.decoding_start_timestamp,
    cdr);
  // Member: decoding_finish_timestamp
  builtin_interfaces::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ros_message.decoding_finish_timestamp,
    cdr);
  // Member: is_dense
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  benchdraco_point_cloud_interfaces::msg::BenchCompressedPointCloud2 & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  // Member: raw_size
  {
    size_t item_size = sizeof(ros_message.raw_size);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // Member: encoding_start_timestamp
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_benchdraco_point_cloud_interfaces
max_serialized_size_BenchCompressedPointCloud2(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = benchdraco_point_cloud_interfaces::msg::BenchCompressedPointCloud2;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const benchdraco_point_cloud_interfaces::msg::BenchCompressedPointCloud2 *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<benchdraco_point_cloud_interfaces::msg::BenchCompressedPointCloud2 *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _BenchCompressedPointCloud2__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const benchdraco_point_cloud_interfaces::msg::BenchCompressedPointCloud2 *>(
...
static size_t _BenchCompressedPointCloud2__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_BenchCompressedPointCloud2(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _BenchCompressedPointCloud2__callbacks = {
...
static rosidl_message_type_support_t _BenchCompressedPointCloud2__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_BenchCompressedPointCloud2__callbacks,
...
template<>
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_benchdraco_point_cloud_interfaces
const rosidl_message_type_support_t *
get_message_type_support_handle<benchdraco_point_cloud_interfaces::msg::BenchCompressedPointCloud2>()
{
  return &benchdraco_point_cloud_interfaces::msg::typesupport_fastrtps_cpp::_BenchCompressedPointCloud2__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, benchdraco_point_cloud_interfaces, msg, BenchCompressedPointCloud2)() {
  return &benchdraco_point_cloud_interfaces::msg::typesupport_fastrtps_cpp::_BenchCompressedPointCloud2__handle;
}
