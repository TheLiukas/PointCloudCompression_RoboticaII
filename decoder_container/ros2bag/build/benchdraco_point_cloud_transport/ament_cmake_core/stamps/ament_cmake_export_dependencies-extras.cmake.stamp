...
set(_exported_dependencies "pluginlib::pluginlib;point_cloud_interfaces::point_cloud_interfaces__rosidl_generator_c;point_cloud_interfaces::point_cloud_interfaces__rosidl_typesupport_fastrtps_c;point_cloud_interfaces::point_cloud_interfaces__rosidl_generator_cpp;point_cloud_interfaces::point_cloud_interfaces__rosidl_typesupport_fastrtps_cpp;point_cloud_interfaces::point_cloud_interfaces__rosidl_typesupport_introspection_c;point_cloud_interfaces::point_cloud_interfaces__rosidl_typesupport_c;point_cloud_interfaces::point_cloud_interfaces__rosidl_typesupport_introspection_cpp;point_cloud_interfaces::point_cloud_interfaces__rosidl_typesupport_cpp;point_cloud_interfaces::point_cloud_interfaces__rosidl_generator_py;benchdraco_point_cloud_interfaces::benchdraco_point_cloud_interfaces__rosidl_generator_c;benchdraco_point_cloud_interfaces::benchdraco_point_cloud_interfaces__rosidl_typesupport_fastrtps_c;benchdraco_point_cloud_interfaces::benchdraco_point_cloud_interfaces__rosidl_generator_cpp;benchdraco_point_cloud_interfaces::benchdraco_point_cloud_interfaces__rosidl_typesupport_fastrtps_cpp;benchdraco_point_cloud_interfaces::benchdraco_point_cloud_interfaces__rosidl_typesupport_introspection_c;benchdraco_point_cloud_interfaces::benchdraco_point_cloud_interfaces__rosidl_typesupport_c;benchdraco_point_cloud_interfaces::benchdraco_point_cloud_interfaces__rosidl_typesupport_introspection_cpp;benchdraco_point_cloud_interfaces::benchdraco_point_cloud_interfaces__rosidl_typesupport_cpp;benchdraco_point_cloud_interfaces::benchdraco_point_cloud_interfaces__rosidl_generator_py;point_cloud_transport::point_cloud_transport;rclcpp::rclcpp;yaml-cpp::yaml-cpp;rcpputils::rcpputils;sensor_msgs::sensor_msgs__rosidl_generator_c;sensor_msgs::sensor_msgs__rosidl_typesupport_fastrtps_c;sensor_msgs::sensor_msgs__rosidl_generator_cpp;sensor_msgs::sensor_msgs__rosidl_typesupport_fastrtps_cpp;sensor_msgs::sensor_msgs__rosidl_typesupport_introspection_c;sensor_msgs::sensor_msgs__rosidl_typesupport_c;sensor_msgs::sensor_msgs__rosidl_typesupport_introspection_cpp;sensor_msgs::sensor_msgs__rosidl_typesupport_cpp;sensor_msgs::sensor_msgs__rosidl_generator_py;sensor_msgs::sensor_msgs_library;std_msgs::std_msgs__rosidl_generator_c;std_msgs::std_msgs__rosidl_typesupport_fastrtps_c;std_msgs::std_msgs__rosidl_generator_cpp;std_msgs::std_msgs__rosidl_typesupport_fastrtps_cpp;std_msgs::std_msgs__rosidl_typesupport_introspection_c;std_msgs::std_msgs__rosidl_typesupport_c;std_msgs::std_msgs__rosidl_typesupport_introspection_cpp;std_msgs::std_msgs__rosidl_typesupport_cpp;std_msgs::std_msgs__rosidl_generator_py")

find_package(ament_cmake_libraries QUIET REQUIRED)

# find_package() all dependencies
# and append their DEFINITIONS INCLUDE_DIRS, LIBRARIES, and LINK_FLAGS
# variables to benchdraco_point_cloud_transport_DEFINITIONS, benchdraco_point_cloud_transport_INCLUDE_DIRS,
# benchdraco_point_cloud_transport_LIBRARIES, and benchdraco_point_cloud_transport_LINK_FLAGS.
# Additionally collect the direct dependency names in
# benchdraco_point_cloud_transport_DEPENDENCIES as well as the recursive dependency names
# in benchdraco_point_cloud_transport_RECURSIVE_DEPENDENCIES.
if(NOT _exported_dependencies STREQUAL "")
  find_package(ament_cmake_core QUIET REQUIRED)
  set(benchdraco_point_cloud_transport_DEPENDENCIES ${_exported_dependencies})
  set(benchdraco_point_cloud_transport_RECURSIVE_DEPENDENCIES ${_exported_dependencies})
  set(_libraries)
  foreach(_dep ${_exported_dependencies})
    ...
    if(NOT "${${_dep}_TARGETS}" STREQUAL "")
      foreach(_target ${${_dep}_TARGETS})
        ...
        if(TARGET "${_target}")
          ...
          if(_include_dirs)
            list_append_unique(benchdraco_point_cloud_transport_INCLUDE_DIRS "${_include_dirs}")
          endif()
    ...
    if(NOT use_modern_cmake)
      if(${_dep}_DEFINITIONS)
        list_append_unique(benchdraco_point_cloud_transport_DEFINITIONS "${${_dep}_DEFINITIONS}")
      endif()
      if(${_dep}_INCLUDE_DIRS)
        list_append_unique(benchdraco_point_cloud_transport_INCLUDE_DIRS "${${_dep}_INCLUDE_DIRS}")
      endif()
      if(${_dep}_LIBRARIES)
        list(APPEND _libraries "${${_dep}_LIBRARIES}")
      endif()
      if(${_dep}_LINK_FLAGS)
        list_append_unique(benchdraco_point_cloud_transport_LINK_FLAGS "${${_dep}_LINK_FLAGS}")
      endif()
      if(${_dep}_RECURSIVE_DEPENDENCIES)
        list_append_unique(benchdraco_point_cloud_transport_RECURSIVE_DEPENDENCIES "${${_dep}_RECURSIVE_DEPENDENCIES}")
      endif()
    endif()
    if(_libraries)
      ament_libraries_deduplicate(_libraries "${_libraries}")
      list(APPEND benchdraco_point_cloud_transport_LIBRARIES "${_libraries}")
    endif()
  endforeach()
endif()
