...
#define NODE_MAIN_LOGGER_NAME "republish"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libpc_republish_node.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<point_cloud_transport::Republisher>";
